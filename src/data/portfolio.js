...
export const pricing = [
  ...
  },
  {
    ...
    for: "KATALOG PRODUK, PROFIL SEKOLAH",
    features: [
      "Website 5–7 halaman",
  ...
  },
  {
    ...
    price: "Rp 1.5jt",
    popular: false,
    desc: "Website dengan database, backend, payment integration",
    for: "BOOKING, TOKO ADVANCED, APLIKASI SEKOLAH",
    features: [
      "Lebih mudah ditemukan di google",
      "Bisa pantau analisis kunjungan website",
  ...
  },
  {
    ...
    popular: false,
    desc: "Budget kamu pas pasan?, ngobrol aja dulu",
    for: "DOMPET TIPIS",
    features: [
      "Website sesuai kantongmu",
      "Request halaman suka suka",
      "Gratis hosting (domain menyesuaikan)",
      "Ngobrol buat sesuaiin fitur dan isi dompet",
    ],
