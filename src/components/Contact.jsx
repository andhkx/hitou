              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-3">
                  <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" aria-hidden="true">
                    <path d={SOCIAL_PATHS[socials[0].icon]} />
                  </svg>
                  <div>
