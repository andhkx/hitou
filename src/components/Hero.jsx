...
export default function Hero() {
  ...
  return (
    ...
    >
{ready && (
        <div className="absolute inset-y-0 right-0 w-full h-full lg:w-[38%] lg:translate-x-[10%] z-0 opacity-70 lg:opacity-100 pointer-events-none lg:pointer-events-auto">
          <Lanyard position={[0, 0, 20]} fov={8} gravity={[0, -40, 0]} lanyardWidth={1.2} />
        </div>
      )}
