...
export default function Features() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold mb-3">Selalu Included</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
        {features.map((f, i) => (
          ...
          >
            <CheckCircle2 size={20} className="text-white/80 shrink-0 mt-0.5" aria-hidden="true" />
            <div>
        ...
        <motion.div
          ...
          className="rounded-2xl border border-white/25 bg-white/[0.05] p-5 flex items-center justify-between gap-4"
        >
          <div>
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-white text-black text-[13px] font-bold px-4 py-2.5 transition-all duration-300 hover:bg-white/90 active:scale-[0.99]"
          >
